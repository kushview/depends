...
WAF=python3 waf
$(1)_waf_configure=python3 waf configure --prefix=$($($(1)_type)_prefix) $$($(1)_config_opts) CC="$$($(1)_cc)" CXX="$$($(1)_cxx)"
ifneq ($($(1)_nm),)
$(1)_waf_configure += NM="$$($(1)_nm)"
endif
ifneq ($($(1)_ranlib),)
$(1)_waf_configure += RANLIB="$$($(1)_ranlib)"
endif
ifneq ($($(1)_ar),)
$(1)_waf_configure += AR="$$($(1)_ar)"
endif
ifneq ($($(1)_cflags),)
$(1)_waf_configure += CFLAGS="$$($(1)_cflags)"
endif
ifneq ($($(1)_cxxflags),)
$(1)_waf_configure += CXXFLAGS="$$($(1)_cxxflags)"
endif
ifneq ($($(1)_cppflags),)
$(1)_waf_configure += CPPFLAGS="$$($(1)_cppflags)"
endif
ifneq ($($(1)_ldflags),)
$(1)_waf_configure += LDFLAGS="$$($(1)_ldflags)"
endif
